    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-light bg-danger">
            ...
            <div class="alert"><?php echo isset($alert) ? $alert: ''; ?></div>
                    ...
                    <input type="email" class="form-control mb-3" name="correo" value="<?php echo $row['correo'] ?>" required>
                    <input type="text" class="form-control mb-3" name="usuario" value="<?php echo $row['usuario'] ?>"required>
                    <input type="password" class="form-control mb-3" name="clave" value="<?php echo $row['clave'] ?>"required>
