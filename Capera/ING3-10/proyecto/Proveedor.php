    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-light bg-danger">
            ...
            <div class="alert"><?php echo isset($alert) ? $alert: ''; ?></div>
                    <input type="text" class="form-control mb-3" name="proveedor" placeholder="Ingrese el nombre del Proveedor" required>
                    <input type="text" class="form-control mb-3" name="contacto" placeholder="Ingrese el nombre del Contacto" required> 
...
<td><a href="ModificarP.php?id=<?php echo$row['codproveedor']?>" class="btn btn-info">Modificar</a></td>
<td><a href="EliminarP.php?id=<?php echo$row['codproveedor']?>" class="btn btn-danger">Eliminar</a></td>
